...
import projet.micro.auth.mapper.UserMapper;
...
public class UserServiceImpl implements UserService, UserDetailsService 
{
    ...
    @Override
    public UserResponseDTO saveUser(UserRequestDTO user) throws UsernameExistException
    {
    	UserResponseDTO userr =this.getUser(user.getUsername());
		if(userr != null) 
		{ 
        ...
        return userMapper.toDto(userRepository.save(userMapper.convertToEntity(user)));
    }
	...
	public void refreshToken(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException 
    {
        ...
        if(authorizationHeader != null && authorizationHeader.startsWith("Bearer "))
        {
            ...
            try
            {
                ...
                UserResponseDTO user = this.getUser(userName);
