...
public class GenericSpecificationsBuilder<T> {
    ...
    public final GenericSpecificationsBuilder<T> with(final String key, final SearchOperation searchOperation, final List<Object> arguments,final String joinTable) {
        return with(key, searchOperation, false, arguments,joinTable);
    }

    public final GenericSpecificationsBuilder<T> with(final String key, final SearchOperation searchOperation, final boolean isOrOperation, final List<Object> arguments,final String joinTable) {
        params.add(new SearchCriteria(key, searchOperation, isOrOperation, arguments,joinTable));
        return this;
    }
